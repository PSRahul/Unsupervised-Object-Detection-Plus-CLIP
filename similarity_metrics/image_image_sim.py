...
class ImageImageSim:
    def __init__(self, model_name, seed_number, shot_number):
        ...
        query_root = "/home/psrahul/MasterThesis/repo/Unsupervised-Object-Detection-Plus-CLIP/features/images/query/"
        query_feature_path = os.path.join(
            query_root, str(model_name), "image_features_support.pt"
        )

        support_root = "/home/psrahul/MasterThesis/repo/Unsupervised-Object-Detection-Plus-CLIP/features/images/support/"
...
def main():
    ...
    df_save_root = "/home/psrahul/MasterThesis/repo/Unsupervised-Object-Detection-Plus-CLIP/exps/v0.1/"
    model_name = [
        ("CLIPModel", 512),
