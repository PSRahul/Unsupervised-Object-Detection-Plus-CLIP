...
class CreateTokenFeatures():
    ...
    def get_text_token_from_desc_list(self, load_name, save_name, load_file_root, save_file_root):
    ...
    def create_image_features_from_classes_folders(self, images_path, images_list, save_folder, save_name, crop_bounding_box=False):
...
def call_get_text_token_from_desc_list():
    ...
    get_text_token_from_desc_list(
        load_name="just_class_names.pt", save_name="text_token_just_class_names.pt", load_file_root=load_file_root, save_file_root=save_file_root)
    get_text_token_from_desc_list(
        load_name="t5_text.pt", save_name="text_token_t5_text.pt", load_file_root=load_file_root, save_file_root=save_file_root)
    get_text_token_from_desc_list(
        load_name="t3_text.pt", save_name="text_token_t3_text.pt", load_file_root=load_file_root, save_file_root=save_file_root)
    get_text_token_from_desc_list(
        load_name="t1_text.pt", save_name="text_token_t1_text.pt", load_file_root=load_file_root, save_file_root=save_file_root)
