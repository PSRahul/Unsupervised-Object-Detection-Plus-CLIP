...
def main():
    ...
    for i in range(len(class_names)):
        ...
        train_path = (
            "/home/psrahul/MasterThesis/datasets/CUB_200_2011/v2/CUB_200_2011/train/"
            + str(class_name)
        )
        Path(train_path).mkdir(parents=True, exist_ok=True)

        test_path = (
            "/home/psrahul/MasterThesis/datasets/CUB_200_2011/v2/CUB_200_2011/test/"
            + str(class_name)
        )
        Path(test_path).mkdir(parents=True, exist_ok=True)

        val_path = (
            "/home/psrahul/MasterThesis/datasets/CUB_200_2011/v2/CUB_200_2011/val/"
            + str(class_name)
        )
        Path(val_path).mkdir(parents=True, exist_ok=True)

        trainval_path = (
            "/home/psrahul/MasterThesis/datasets/CUB_200_2011/v2/CUB_200_2011/trainval/"
            + str(class_name)
        )
        ...
        test_idx = random_idx[train_size + val_size : train_size + val_size + test_size]
        print(train_idx)
        print(val_idx)
        print(test_idx)
